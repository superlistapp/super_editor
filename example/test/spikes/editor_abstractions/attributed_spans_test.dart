  ...
  group('Spans', () {
    group('single attribution', () {
      test('applies attribution to full span', () {
        ...
        spans.addAttribution(name: 'bold', start: 0, end: 16);

        expect(spans.attributions.length, 2);
        expect(spans.attributions[0], SpanMarker(name: 'bold', offset: 0, markerType: SpanMarkerType.start));
        expect(spans.attributions[1], SpanMarker(name: 'bold', offset: 16, markerType: SpanMarkerType.end));
      });

      test('applies attribution to beginning of span', () {
        final spans = AttributedSpans(length: 17);

        spans.addAttribution(name: 'bold', start: 0, end: 7);

        expect(spans.attributions.length, 2);
        expect(spans.attributions[0], SpanMarker(name: 'bold', offset: 0, markerType: SpanMarkerType.start));
        expect(spans.attributions[1], SpanMarker(name: 'bold', offset: 7, markerType: SpanMarkerType.end));
      });

      test('applies attribution to inner span', () {
        final spans = AttributedSpans(length: 17);

        spans.addAttribution(name: 'bold', start: 2, end: 7);

        expect(spans.attributions.length, 2);
        expect(spans.attributions[0], SpanMarker(name: 'bold', offset: 2, markerType: SpanMarkerType.start));
        expect(spans.attributions[1], SpanMarker(name: 'bold', offset: 7, markerType: SpanMarkerType.end));
      });
      ...
      test('applies attribution to end of span', () {
        ...
        spans.addAttribution(name: 'bold', start: 7, end: 16);

        expect(spans.attributions.length, 2);
        expect(spans.attributions[0], SpanMarker(name: 'bold', offset: 7, markerType: SpanMarkerType.start));
        expect(spans.attributions[1], SpanMarker(name: 'bold', offset: 16, markerType: SpanMarkerType.end));
      });
      ...
      test('removes attribution from full span', () {
        ...
        spans.removeAttribution(name: 'bold', start: 0, end: 16);
      ...
      test('removes attribution from inner text span', () {
        ...
        spans.removeAttribution(name: 'bold', start: 2, end: 7);
      ...
      test('removes attribution from partial beginning span', () {
        ...
        spans.removeAttribution(name: 'bold', start: 2, end: 4);

        expect(spans.attributions.length, 2);
        expect(spans.attributions[0], SpanMarker(name: 'bold', offset: 5, markerType: SpanMarkerType.start));
        expect(spans.attributions[1], SpanMarker(name: 'bold', offset: 7, markerType: SpanMarkerType.end));
      });
      ...
      test('removes attribution from partial inner span', () {
        ...
        spans.removeAttribution(name: 'bold', start: 4, end: 5);

        expect(spans.attributions.length, 4);
        expect(spans.attributions[0], SpanMarker(name: 'bold', offset: 2, markerType: SpanMarkerType.start));
        expect(spans.attributions[1], SpanMarker(name: 'bold', offset: 3, markerType: SpanMarkerType.end));
        expect(spans.attributions[2], SpanMarker(name: 'bold', offset: 6, markerType: SpanMarkerType.start));
        expect(spans.attributions[3], SpanMarker(name: 'bold', offset: 7, markerType: SpanMarkerType.end));
      });
      ...
      test('removes attribution from partial ending span', () {
        ...
        spans.removeAttribution(name: 'bold', start: 5, end: 7);

        expect(spans.attributions.length, 2);
        expect(spans.attributions[0], SpanMarker(name: 'bold', offset: 2, markerType: SpanMarkerType.start));
        expect(spans.attributions[1], SpanMarker(name: 'bold', offset: 4, markerType: SpanMarkerType.end));
      });
      ...
      test('applies attribution when mixed span is toggled', () {
        ...
        spans.toggleAttribution(name: 'bold', start: 0, end: 16);
    ...
    group('multiple attributions', () {
      test('full length overlap', () {
        ...
        spans.addAttribution(name: 'b', start: 0, end: 9);
        spans.addAttribution(name: 'i', start: 0, end: 9);
      ...
      test('half and half', () {
        ...
        spans.addAttribution(name: 'b', start: 5, end: 9);
        spans.addAttribution(name: 'i', start: 0, end: 4);
      ...
      test('two partial overlap', () {
        ...
        spans.addAttribution(name: 'b', start: 4, end: 8);
        spans.addAttribution(name: 'i', start: 1, end: 5);
      ...
      test('three partial overlap', () {
        ...
        spans.addAttribution(name: 'b', start: 4, end: 8);
        spans.addAttribution(name: 'i', start: 1, end: 5);
        spans.addAttribution(name: 's', start: 5, end: 9);
      ...
      test('many small segments', () {
        ...
        spans.addAttribution(name: 'b', start: 0, end: 1);
        spans.addAttribution(name: 'i', start: 2, end: 3);
        spans.addAttribution(name: 's', start: 4, end: 5);
        spans.addAttribution(name: 'b', start: 6, end: 7);
        spans.addAttribution(name: 'i', start: 8, end: 9);
  ...
  void expectSpans(AttributedSpans spans) {
    for (int characterIndex = 0; characterIndex < _combinedSpans.length; ++characterIndex) {
      for (int attributionIndex = 0; attributionIndex < _combinedSpans[characterIndex].length; ++attributionIndex) {
        ...
        expect(spans.hasAttributionAt(characterIndex, name: attributionName), true);
      }
    }
  }
}
