    ...
    _composer = DocumentComposer(
      initialSelection: DocumentSelection.collapsed(
        position: DocumentPosition(
          nodeId: _bodyParagraphNodeId,
          nodePosition: const TextPosition(
            offset: _initialBodyParagraphText.length,
          ),
        ),
      ),
...
final _bodyParagraphNodeId = DocumentEditor.createNodeId();
const _initialBodyParagraphText =
    'The missing WYSIWYG editor for Flutter. Open source and written '
    'entirely in Dart. Comes with a modular architecture that allows '
    'you to customize it to your needs. Why not try it out?';
...
MutableDocument _createInitialDocument() {
  return MutableDocument(
    nodes: [
      ...
      ParagraphNode(
        id: _bodyParagraphNodeId,
        text: AttributedText(
          text: _initialBodyParagraphText,
...
Widget _centeredHeaderBuilder(ComponentContext context) {
