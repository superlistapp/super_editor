...
void main() {
  group("SuperEditor task component", () {
    ...
    testWidgetsOnAllPlatforms("combines with previous paragraph when the user presses BACKSPACE at the beginning",
        (tester) async {
      final document = MutableDocument(
        nodes: [
          ParagraphNode(id: "1", text: AttributedText(text: "This is a paragraph")),
          TaskNode(id: "2", text: AttributedText(text: "This is a task"), isComplete: false),
        ],
      );
      ...
      // Ensure the task was merged with the previous paragraph.
      expect(document.nodes.length, 1);
    ...
    testWidgetsOnAllPlatforms(
        "combines with previous paragraph when the user presses BACKSPACE with software keyboard at the beginning",
        (tester) async {
      final document = MutableDocument(
        nodes: [
          ParagraphNode(id: "1", text: AttributedText(text: "This is a paragraph")),
