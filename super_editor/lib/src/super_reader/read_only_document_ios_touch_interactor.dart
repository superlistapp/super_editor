...
class _ReadOnlyIOSDocumentTouchInteractorState extends State<ReadOnlyIOSDocumentTouchInteractor>
  ...
  void _showEditingControlsOverlay() {
    ...
    _controlsOverlayEntry = OverlayEntry(builder: (overlayContext) {
      return ReadOnlyIosDocumentTouchEditingControls(
...
class ReadOnlyIosDocumentTouchEditingControls extends StatefulWidget {
  const ReadOnlyIosDocumentTouchEditingControls({
    Key? key,
  ...
  @override
  State createState() => _ReadOnlyIosDocumentTouchEditingControlsState();
}

class _ReadOnlyIosDocumentTouchEditingControlsState extends State<ReadOnlyIosDocumentTouchEditingControls>
  ...
  @override
  void didUpdateWidget(ReadOnlyIosDocumentTouchEditingControls oldWidget) {
    super.didUpdateWidget(oldWidget);
